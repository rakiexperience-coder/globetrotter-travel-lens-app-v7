 ...
 * @param title The title to be displayed at the top of the album page.
 * @returns A promise that resolves to a data URL of the generated album page (PNG format).
 */
export async function createAlbumPage(imageData: Record<string, string>, title: string): Promise<string> {
    ...
    ctx.fillText(title, canvasWidth / 2, 180);
    ...
    // Convert canvas to a PNG and return the data URL
